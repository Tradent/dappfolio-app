...
function PortfolioValueChart() {
  ...
  const blueColors = {
    stroke: "#3b82f6", // babyblue-500
    fill: "#93c5fd", // babyblue-300
    gradient1: "#dbeafe", // babyblue-100
    gradient2: "#bfdbfe", // babyblue-200
  }
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
              ...
              />
              <Tooltip
                formatter={(value: any, name: any) => [`${Number(value).toLocaleString()}`, "Portfolio Value"]}
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
              ...
              />
              <Tooltip
                formatter={(value: any) => [`${value}`, "Token Price"]}
                contentStyle={{ backgroundColor: "#ffffff", borderColor: "#e5e7eb" }}
              />
              <Line
                type="monotone"
